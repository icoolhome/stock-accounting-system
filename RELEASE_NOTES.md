...
- **transactions 表索引**：user_id, trade_date, stock_code, securities_account_id, 複合索引
- **settlements 表索引**：user_id, settlement_date, bank_account_id, transaction_id, 複合索引
- **dividends 表索引**：user_id, record_date, stock_code, 複合索引
- **holdings 表索引**：user_id, stock_code, securities_account_id
- **bank_transactions 表索引**：user_id, transaction_date, bank_account_id, 複合索引
- **其他表索引**：bank_accounts, securities_accounts, system_settings, income_types 等
